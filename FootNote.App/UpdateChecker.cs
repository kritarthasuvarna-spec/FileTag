...
{
    public const string RepoSlug = "kritarthasuvarna-spec/FootNote";
    ...
    public static async Task CheckAsync(TrayIcon tray)
    {
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("FootNote", "1.0"));
            ...
            if (latest > current)
            {
                tray.ShowBalloon("FootNote update available",
