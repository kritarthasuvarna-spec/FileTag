...
/// <summary>
/// Last-resort local backup of every note FootNote has ever saved — a compact,
...
public static class NotesBackup
{
    ...
    private static List<Entry> Load()
    {
        ...
        return JsonSerializer.Deserialize(gz, FootNoteJsonContext.Default.ListEntry) ?? new();
    }
    ...
    private static void Save(List<Entry> entries)
    {
        ...
        {
            JsonSerializer.Serialize(gz, entries, FootNoteJsonContext.Default.ListEntry);
        }
